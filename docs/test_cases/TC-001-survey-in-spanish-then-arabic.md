...
|------|---------------------------|---------------------------------------------------------------------------------------------------------------|------------------|-------------------------------------------------------------------|
| 1    | Open Spanish link         | The respondent opens the login page from a link that carries the Spanish language                             | es-419           | [UC-007](../use_cases/UC-007-complete-the-survey-in-my-language.md) |
...
| 3    | Switch to Arabic          | The respondent chooses Arabic in the language selector                                                        | ar               | [UC-007](../use_cases/UC-007-complete-the-survey-in-my-language.md) |
