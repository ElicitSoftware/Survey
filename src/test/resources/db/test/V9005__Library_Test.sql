...
INSERT INTO survey.surveys(id, display_order, name, title, description, initial_display_key, post_survey_url, survey_key)
VALUES (NEXTVAL('survey.surveys_seq'), 2,
        ...
        '0000-0001-0000-0001-0000-0000-0000', NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.select_groups_seq'), v_survey_id, 'YesNo',          'Boolean yes/no choice',                'Text', gen_random_uuid())
RETURNING id INTO v_sg_yesno;

INSERT INTO survey.select_groups(id, survey_id, name, description, data_type, select_group_key)
VALUES (NEXTVAL('survey.select_groups_seq'), v_survey_id, 'MediaType',      'Library media categories',             'Text', gen_random_uuid())
RETURNING id INTO v_sg_mediatype;

INSERT INTO survey.select_groups(id, survey_id, name, description, data_type, select_group_key)
VALUES (NEXTVAL('survey.select_groups_seq'), v_survey_id, 'LiteraryGenre',  'Reading genre preferences',            'Text', gen_random_uuid())
RETURNING id INTO v_sg_literarygenre;

INSERT INTO survey.select_groups(id, survey_id, name, description, data_type, select_group_key)
VALUES (NEXTVAL('survey.select_groups_seq'), v_survey_id, 'PickupBranch',   'Library branch locations',             'Text', gen_random_uuid())
RETURNING id INTO v_sg_pickupbranch;

INSERT INTO survey.select_groups(id, survey_id, name, description, data_type, select_group_key)
VALUES (NEXTVAL('survey.select_groups_seq'), v_survey_id, 'VisitFrequency', 'How often the patron visits',          'Text', gen_random_uuid())
RETURNING id INTO v_sg_visitfreq;

INSERT INTO survey.select_groups(id, survey_id, name, description, data_type, select_group_key)
VALUES (NEXTVAL('survey.select_groups_seq'), v_survey_id, 'ItemType',       'Type of item being checked out',       'Text', gen_random_uuid())
RETURNING id INTO v_sg_itemtype;

INSERT INTO survey.select_groups(id, survey_id, name, description, data_type, select_group_key)
VALUES (NEXTVAL('survey.select_groups_seq'), v_survey_id, 'EbookFormat',    'Preferred digital reading format',     'Text', gen_random_uuid())
...
VALUES (NEXTVAL('survey.steps_seq'), v_survey_id, 1, 'Welcome', 'Welcome', 'Library welcome and terms of use consent', gen_random_uuid())
RETURNING id INTO v_step_welcome;

-- Step: Patron --
INSERT INTO survey.steps(id, survey_id, display_order, name, dimension_name, description, step_key)
VALUES (NEXTVAL('survey.steps_seq'), v_survey_id, 2, 'Patron', 'Patron', 'Patron account and contact information', gen_random_uuid())
RETURNING id INTO v_step_patron;

-- Step: Preferences --
INSERT INTO survey.steps(id, survey_id, display_order, name, dimension_name, description, step_key)
VALUES (NEXTVAL('survey.steps_seq'), v_survey_id, 3, 'Preferences', 'Preferences', 'Collection and visit preferences', gen_random_uuid())
RETURNING id INTO v_step_prefs;

-- Step: CheckoutRequest — one step; checkout section and renewal section both repeat within it --
INSERT INTO survey.steps(id, survey_id, display_order, name, dimension_name, description, step_key)
VALUES (NEXTVAL('survey.steps_seq'), v_survey_id, 4, 'CheckoutRequest', 'Checkout', 'Checkout request items and renewal scheduling', gen_random_uuid())
...
VALUES (NEXTVAL('survey.sections_seq'), v_survey_id, 1, 'Welcome', 'Welcome', 'Welcome and library terms of use', gen_random_uuid())
RETURNING id INTO v_sect_welcome;

-- Section: Patron Information --
INSERT INTO survey.sections(id, survey_id, display_order, name, dimension_name, description, section_key)
VALUES (NEXTVAL('survey.sections_seq'), v_survey_id, 2, 'Patron Information', 'Patron', 'Account and contact details', gen_random_uuid())
RETURNING id INTO v_sect_patron;

-- Section: Digital Access — conditionally shown when Q45 (wants digital) = TRUE --
INSERT INTO survey.sections(id, survey_id, display_order, name, dimension_name, description, section_key)
VALUES (NEXTVAL('survey.sections_seq'), v_survey_id, 3, 'Digital Access', 'DigitalAccess', 'Digital library card and notification preferences', gen_random_uuid())
RETURNING id INTO v_sect_digital;

-- Section: Collection Preferences --
INSERT INTO survey.sections(id, survey_id, display_order, name, dimension_name, description, section_key)
VALUES (NEXTVAL('survey.sections_seq'), v_survey_id, 4, 'Collection Preferences', 'Preferences', 'Media interests and visit habits', gen_random_uuid())
RETURNING id INTO v_sect_collprefs;

-- Section: Media Preferences — conditionally shown when Q50 (media types) CONTAINS 'dvd' --
INSERT INTO survey.sections(id, survey_id, display_order, name, dimension_name, description, section_key)
VALUES (NEXTVAL('survey.sections_seq'), v_survey_id, 5, 'Media Preferences', 'Media', 'DVD and media availability preferences', gen_random_uuid())
...
INSERT INTO survey.sections(id, survey_id, display_order, name, dimension_name, description, section_key)
VALUES (NEXTVAL('survey.sections_seq'), v_survey_id, 6, 'Checkout {S#}', 'Checkout', 'Details for one checkout item', gen_random_uuid())
...
INSERT INTO survey.sections(id, survey_id, display_order, name, dimension_name, description, section_key)
VALUES (NEXTVAL('survey.sections_seq'), v_survey_id, 7, 'Renewal {S#}', 'Renewal', 'Renewal scheduling for one renewal period', gen_random_uuid())
...
VALUES (NEXTVAL('survey.steps_sections_seq'), v_survey_id, v_step_checkout, 4, v_sect_checkout,   6,
        LPAD(v_survey_id::text, 4, '0') || '-0004-0000-0006-0000-0000-0000', gen_random_uuid())
RETURNING id INTO v_ss_checkout;

INSERT INTO survey.steps_sections(id, survey_id, step_id, step_display_order, section_id, section_display_order, display_key, steps_sections_key)
VALUES (NEXTVAL('survey.steps_sections_seq'), v_survey_id, v_step_checkout, 4, v_sect_renewal,    7,
        LPAD(v_survey_id::text, 4, '0') || '-0004-0000-0007-0000-0000-0000', gen_random_uuid())
...
INSERT INTO survey.questions(id, survey_id, type_id, text, short_text, tool_tip, variant, required, min_value, max_value, validation_text, select_group_id, mask, placeholder, default_value, question_key)
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 4,
        ...
        'Welcome', '', '', FALSE, NULL, NULL, '', NULL, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 1,
        ...
        'Terms of Use', '', '', TRUE, NULL, NULL, 'You must agree to the terms before continuing.', NULL, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 4,
        ...
        'Terms Confirmed', '', '', FALSE, NULL, NULL, '', NULL, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 8,
        'First name',
        'First name', '', '', TRUE, 2, 50, 'First name must be at least 2 characters.', NULL, NULL, 'First name', NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 8,
        'Last name',
        'Last name', '', '', TRUE, 2, 50, 'Last name must be at least 2 characters.', NULL, NULL, 'Last name', NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 13,
        'Email address',
        'Email', 'This will be used to notify you of holds and due dates', '', TRUE, NULL, NULL, '', NULL, NULL, 'you@example.com', NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 14,
        ...
        'PIN', 'Minimum 4 digits or 8 characters', '', TRUE, NULL, NULL, 'A PIN or password is required.', NULL, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 8,
        ...
        'Phone', '', '', FALSE, 12, 12, 'Please enter a valid phone number (###-###-####).', NULL, NULL, '###-###-####', NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 2,
        ...
        'Date of birth', 'Required for cardholders under 18', '', TRUE, NULL, NULL, '', NULL, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 7,
        ...
        'Digital access', '', 'vertical', TRUE, NULL, NULL, '', v_sg_yesno, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 3,
        ...
        'Ebook format', '', '', TRUE, NULL, NULL, '', v_sg_ebookformat, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 1,
        ...
        'Arrival notifications', '', '', FALSE, NULL, NULL, '', NULL, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 1,
        ...
        'Notify via email', '', '', FALSE, NULL, NULL, '', NULL, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 1,
        'Send via SMS {PHONE}',
        'Notify via SMS', '', '', FALSE, NULL, NULL, '', NULL, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 5,
        ...
        'Checkout count', '', 'vertical', TRUE, 1, 10, 'Must be between 1 and 10.', NULL, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 11,
        ...
        'Media types', '', 'vertical', TRUE, NULL, NULL, '', v_sg_mediatype, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 8,
        ...
        'Narrator', '', '', FALSE, NULL, NULL, '', NULL, NULL, 'e.g., Scott Brick, Bahni Turpin', NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 8,
        ...
        'Streaming service', '', '', FALSE, NULL, NULL, '', NULL, NULL, 'e.g., Libby, Hoopla, Audible', NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 10,
        ...
        'Genres', '', '', FALSE, NULL, NULL, '', v_sg_literarygenre, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 9,
        ...
        'Mystery authors', 'We will prioritize these for your hold queue', '', FALSE, NULL, NULL, '', NULL, NULL, 'e.g., Agatha Christie, Gillian Flynn, Michael Connelly', NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 6,
        ...
        'Weekly reading hours', '', '', FALSE, 0, 168, 'Must be between 0 and 168.', NULL, NULL, 'e.g., 5.5', '2.0', gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 7,
        ...
        'Visit frequency', '', 'vertical', TRUE, NULL, NULL, '', v_sg_visitfreq, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 8,
        ...
        'Preferred branch', '', '', FALSE, NULL, NULL, '', NULL, NULL, 'e.g., Main Branch', NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 8,
        ...
        'DVD genres', '', '', FALSE, NULL, NULL, '', NULL, NULL, 'e.g., Action, Documentary, Family', NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 2,
        ...
        'Availability date', '', '', FALSE, NULL, NULL, '', NULL, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 12,
        ...
        'Pickup time', '', '', FALSE, NULL, NULL, '', NULL, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 8,
        ...
        'Item title', '', '', TRUE, 1, 255, 'Please enter the item title.', NULL, NULL, 'e.g., The Great Gatsby, Inception (DVD)', NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 5,
        ...
        'Renewals', '', 'vertical', TRUE, 0, 3, 'Must be between 0 and 3.', NULL, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 7,
        ...
        'Item type', '', 'vertical', TRUE, NULL, NULL, '', v_sg_itemtype, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 8,
        ...
        'Format notes', '', '', FALSE, NULL, NULL, '', NULL, NULL, 'e.g., Blu-ray, unabridged, MP3 CD', NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 1,
        ...
        'Place on hold', 'We will notify you when the item is ready', '', FALSE, NULL, NULL, '', NULL, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 9,
        ...
        'Hold instructions', '', '', FALSE, NULL, NULL, '', NULL, NULL, 'e.g., Specific edition needed, contact by phone only', NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 2,
        ...
        'Renewal date', '', '', TRUE, NULL, NULL, '', NULL, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 3,
        ...
        'Pickup branch', '', '', TRUE, NULL, NULL, '', v_sg_pickupbranch, NULL, NULL, NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.questions_seq'), v_survey_id, 8,
        ...
        'Alternate contact', '', '', FALSE, NULL, NULL, '', NULL, NULL, 'Full name of alternate contact', NULL, gen_random_uuid())
...
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q36, v_sect_welcome, 1, gen_random_uuid())
RETURNING id INTO v_sq36;  -- sq36: Q36 HTML welcome

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q37, v_sect_welcome, 2, gen_random_uuid())
RETURNING id INTO v_sq37;  -- sq37: Q37 CHECKBOX terms

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q38, v_sect_welcome, 3, gen_random_uuid())
RETURNING id INTO v_sq38;  -- sq38: Q38 HTML confirmation

-- Section: Patron Information (sq39–sq45)
INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q39, v_sect_patron, 1, gen_random_uuid())
RETURNING id INTO v_sq39;  -- sq39: Q39 TEXT first name

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q40, v_sect_patron, 2, gen_random_uuid())
RETURNING id INTO v_sq40;  -- sq40: Q40 TEXT last name

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q41, v_sect_patron, 3, gen_random_uuid())
RETURNING id INTO v_sq41;  -- sq41: Q41 EMAIL

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q42, v_sect_patron, 4, gen_random_uuid())
RETURNING id INTO v_sq42;  -- sq42: Q42 PASSWORD

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q43, v_sect_patron, 5, gen_random_uuid())
RETURNING id INTO v_sq43;  -- sq43: Q43 TEXT phone

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q44, v_sect_patron, 6, gen_random_uuid())
RETURNING id INTO v_sq44;  -- sq44: Q44 DATE_PICKER DOB

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q45, v_sect_patron, 7, gen_random_uuid())
RETURNING id INTO v_sq45;  -- sq45: Q45 RADIO digital access

-- Section: Digital Access (sq46–sq48)
INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q46, v_sect_digital, 1, gen_random_uuid())
RETURNING id INTO v_sq46;  -- sq46: Q46 COMBOBOX ebook format

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q47, v_sect_digital, 2, gen_random_uuid())
RETURNING id INTO v_sq47;  -- sq47: Q47 CHECKBOX notifications

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q48, v_sect_digital, 3, gen_random_uuid())
RETURNING id INTO v_sq48;  -- sq48: Q48 CHECKBOX notify via email

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q48b, v_sect_digital, 4, gen_random_uuid())
RETURNING id INTO v_sq48b;  -- sq48b: Q48b CHECKBOX notify via SMS

-- Section: Collection Preferences (sq49–sq57)
INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q49, v_sect_collprefs, 1, gen_random_uuid())
RETURNING id INTO v_sq49;  -- sq49: Q49 INTEGER checkout count

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q50, v_sect_collprefs, 2, gen_random_uuid())
RETURNING id INTO v_sq50;  -- sq50: Q50 CHECKBOX_GROUP media types

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q51, v_sect_collprefs, 3, gen_random_uuid())
RETURNING id INTO v_sq51;  -- sq51: Q51 TEXT narrator (chain L2)

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q52, v_sect_collprefs, 4, gen_random_uuid())
RETURNING id INTO v_sq52;  -- sq52: Q52 TEXT streaming (chain L3)

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q53, v_sect_collprefs, 5, gen_random_uuid())
RETURNING id INTO v_sq53;  -- sq53: Q53 MULTI_SELECT genres

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q54, v_sect_collprefs, 6, gen_random_uuid())
RETURNING id INTO v_sq54;  -- sq54: Q54 TEXTAREA mystery authors

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q55, v_sect_collprefs, 7, gen_random_uuid())
RETURNING id INTO v_sq55;  -- sq55: Q55 DOUBLE reading hours

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q56, v_sect_collprefs, 8, gen_random_uuid())
RETURNING id INTO v_sq56;  -- sq56: Q56 RADIO visit frequency

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q57, v_sect_collprefs, 9, gen_random_uuid())
RETURNING id INTO v_sq57;  -- sq57: Q57 TEXT preferred branch

-- Section: Media Preferences (sq58–sq60)
INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q58, v_sect_mediaprefs, 1, gen_random_uuid())
RETURNING id INTO v_sq58;  -- sq58: Q58 TEXT DVD genres

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q59, v_sect_mediaprefs, 2, gen_random_uuid())
RETURNING id INTO v_sq59;  -- sq59: Q59 DATE_PICKER availability

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q60, v_sect_mediaprefs, 3, gen_random_uuid())
RETURNING id INTO v_sq60;  -- sq60: Q60 DATETIME pickup time

-- Section: Checkout Request (sq61–sq66)
INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q61, v_sect_checkout, 1, gen_random_uuid())
RETURNING id INTO v_sq61;  -- sq61: Q61 TEXT item title → {S1}

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q62, v_sect_checkout, 2, gen_random_uuid())
RETURNING id INTO v_sq62;  -- sq62: Q62 INTEGER renewals → REPEAT ss_renewal

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q63, v_sect_checkout, 3, gen_random_uuid())
RETURNING id INTO v_sq63;  -- sq63: Q63 RADIO item type

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q64, v_sect_checkout, 4, gen_random_uuid())
RETURNING id INTO v_sq64;  -- sq64: Q64 TEXT format notes

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q65, v_sect_checkout, 5, gen_random_uuid())
RETURNING id INTO v_sq65;  -- sq65: Q65 CHECKBOX hold request

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q66, v_sect_checkout, 6, gen_random_uuid())
RETURNING id INTO v_sq66;  -- sq66: Q66 TEXTAREA hold instructions

-- Section: Renewal (sq67–sq69)
INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q67, v_sect_renewal, 1, gen_random_uuid())
RETURNING id INTO v_sq67;  -- sq67: Q67 DATE_PICKER renewal date {Q#}

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q68, v_sect_renewal, 2, gen_random_uuid())
RETURNING id INTO v_sq68;  -- sq68: Q68 COMBOBOX pickup branch

INSERT INTO survey.sections_questions(id, survey_id, question_id, section_id, display_order, sections_question_key)
VALUES (NEXTVAL('survey.sections_questions_seq'), v_survey_id, v_q69, v_sect_renewal, 3, gen_random_uuid())
...
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_welcome, v_sq37, NULL, v_sq38, NULL, 1, 1, NULL, 'Show terms-confirmed message when patron checks the agreement box', '', '', gen_random_uuid());
...
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_welcome, v_sq37, v_step_patron, NULL, v_ss_patron, 1, 1, NULL, 'Show Patron step when patron accepts the terms of use', '', '', gen_random_uuid());
...
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_welcome, v_sq37, v_step_prefs, NULL, v_ss_collprefs, 1, 1, NULL, 'Show Preferences step when patron accepts the terms of use', '', '', gen_random_uuid());
...
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_patron, v_sq41, NULL, 13, v_ss_digital, 5, 3, 'EMAIL', 'Substitute {EMAIL} token in Digital Access section with patron email address', '', '', gen_random_uuid());
...
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_patron, v_sq43, NULL, 14, v_ss_digital, 5, 3, 'PHONE', 'Substitute {PHONE} token in Digital Access section with patron phone number', '', '', gen_random_uuid());
...
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_patron, v_sq45, NULL, NULL, v_ss_digital, 3, 1, NULL, 'Show Digital Access section when patron opts in to digital library', 'TRUE', '', gen_random_uuid());

-- R22: Q47(sq47) BOOLEAN SHOW → Q48(sq48)
--      Operator: BOOLEAN | Action: SHOW | Exercises: second BOOLEAN SHOW (within conditional section)
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_patron, v_sq47, NULL, v_sq48, NULL, 1, 1, NULL, 'Show email notification checkbox when patron opts in to arrival alerts', '', '', gen_random_uuid());

-- R22b: Q47(sq47) BOOLEAN SHOW → Q48b(sq48b)
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_patron, v_sq47, NULL, v_sq48b, NULL, 1, 1, NULL, 'Show SMS notification checkbox when patron opts in to arrival alerts', '', '', gen_random_uuid());
...
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_prefs, v_sq49, v_step_checkout, NULL, v_ss_checkout, 2, 2, NULL, 'Repeat Checkout section once for each item the patron wants to check out', '0', '', gen_random_uuid());
...
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_prefs, v_sq50, NULL, NULL, v_ss_mediaprefs, 6, 1, NULL, 'Show Media Preferences section when DVDs are selected', 'dvd', '', gen_random_uuid());
...
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_prefs, v_sq50, NULL, v_sq51, NULL, 6, 1, NULL, 'Show favorite narrator question when audio books are selected', 'audiobook', '', gen_random_uuid());
...
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_prefs, v_sq51, NULL, v_sq52, NULL, 5, 1, NULL, 'Show preferred streaming service question once a narrator has been entered (nested chain L3)', '', '', gen_random_uuid());
...
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_prefs, v_sq53, NULL, v_sq54, NULL, 6, 1, NULL, 'Show mystery author textarea when Mystery/Thriller genre is selected', 'mystery', '', gen_random_uuid());
...
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_prefs, v_sq56, NULL, v_sq57, NULL, 4, 1, NULL, 'Show preferred branch question when patron visits at least rarely', 'never', '', gen_random_uuid());
...
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_checkout, v_sq62, v_step_checkout, NULL, v_ss_renewal, 2, 2, NULL, 'Repeat Renewal section once for each renewal period the patron needs', '0', '', gen_random_uuid());
...
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_checkout, v_sq63, NULL, v_sq64, NULL, 4, 1, NULL, 'Show format/edition notes for DVDs, audio books, and eMagazines', 'book', '', gen_random_uuid());

-- R31: Q65(sq65) BOOLEAN SHOW → Q66(sq66)
--      Operator: BOOLEAN | Action: SHOW | Exercises: third BOOLEAN SHOW (in repeated step context)
INSERT INTO survey.relationships(id, survey_id, upstream_step_id, upstream_sq_id, downstream_step_id, downstream_sq_id, downstream_ss_id, operator_id, action_id, token, description, reference_value, default_upstream_value, relationship_key)
VALUES (NEXTVAL('survey.relationships_seq'), v_survey_id, v_step_checkout, v_sq65, NULL, v_sq66, NULL, 1, 1, NULL, 'Show hold instructions textarea when patron requests a hold', '', '', gen_random_uuid());
...
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_yesno, 'Yes', 1, 'TRUE', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_yesno, 'No',  2, 'FALSE', gen_random_uuid());

-- Group: MediaType — coded_values match CONTAINS reference_values in R24 and R25 --
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_mediatype, 'Books',       1, 'book', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_mediatype, 'DVDs',        2, 'dvd', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_mediatype, 'Audio Books', 3, 'audiobook', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_mediatype, 'eBooks',      4, 'ebook', gen_random_uuid());

-- Group: LiteraryGenre — coded_value 'mystery' matches R27 reference_value --
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_literarygenre, 'Mystery / Thriller', 1, 'mystery', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_literarygenre, 'Sci-Fi / Fantasy',   2, 'scifi', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_literarygenre, 'Romance',            3, 'romance', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_literarygenre, 'Non-Fiction',        4, 'nonfiction', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_literarygenre, 'Biography',          5, 'biography', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_literarygenre, 'History',            6, 'history', gen_random_uuid());

-- Group: PickupBranch — used by Q68 COMBOBOX in Renewal section --
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_pickupbranch, 'Main Branch',  1, 'main', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_pickupbranch, 'North Branch', 2, 'north', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_pickupbranch, 'South Branch', 3, 'south', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_pickupbranch, 'East Branch',  4, 'east', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_pickupbranch, 'West Branch',  5, 'west', gen_random_uuid());

-- Group: VisitFrequency — coded_value 'never' matches R28 reference_value --
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_visitfreq, 'Daily',   1, 'daily', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_visitfreq, 'Weekly',  2, 'weekly', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_visitfreq, 'Monthly', 3, 'monthly', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_visitfreq, 'Rarely',  4, 'rarely', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_visitfreq, 'Never',   5, 'never', gen_random_uuid());

-- Group: ItemType — coded_value 'book' matches R30 NOT_EQUAL reference_value --
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_itemtype, 'Book',       1, 'book', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_itemtype, 'DVD',        2, 'dvd', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_itemtype, 'Audio Book', 3, 'audiobook', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_itemtype, 'eMagazine',  4, 'emagazine', gen_random_uuid());

-- Group: EbookFormat — used by Q46 COMBOBOX in Digital Access section --
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_ebookformat, 'EPUB', 1, 'epub', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_ebookformat, 'PDF',  2, 'pdf', gen_random_uuid());
INSERT INTO survey.select_items(id, survey_id, select_group_id, display_text, display_order, coded_value, select_item_key)
VALUES (NEXTVAL('survey.select_items_seq'), v_survey_id, v_sg_ebookformat, 'MOBI', 3, 'mobi', gen_random_uuid());
