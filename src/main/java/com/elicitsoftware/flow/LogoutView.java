...
public class LogoutView extends VerticalLayout {
    ...
    /**
     * Invalidates the current user session and clears the session reference.
     * <p>
     * This method is used to log out the current user by:
     * 1. Invalidating the current HTTP session, ensuring all session attributes are cleared on the server.
     * 2. Setting the current session to null to remove the session reference in the application.
     * <p>
